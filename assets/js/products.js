...
const productsList = document.getElementById("productsContainer") || document.getElementById("productsSection");
...
async function fetchProducts() {
  ...
  if (error) {
    ...
    if (productsList) productsList.innerHTML = "<p style='text-align:center;color:#aaa'>حدث خطأ في تحميل المنتجات.</p>";
    return;
  }
